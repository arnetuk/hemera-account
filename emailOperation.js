...
let EMAIL_ID = process.env.EMAIL_KEY || 'AKIAI56MYIAHWKZA3I6A'
let EMAIL_SECRET = process.env.EMAIL_SECRET || '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'
let client = ses.createClient({ key: EMAIL_ID, secret: EMAIL_SECRET })
